// Icon components collection with Google Material Icons
...
export const PageIcon = () => (
  <svg className="w-full h-full" fill="currentColor" viewBox="0 0 24 24">
    <path d="M16 4h2v16h-2zm-4-2v20h2V2zm-4 4h2v12H8zm-4 2h2v8H4z"/>
  </svg>
);
...
export const FlowIcon = () => (
  <svg className="w-full h-full" fill="currentColor" viewBox="0 0 24 24">
    <path d="M21.71,11.29L16.71,6.29A1,1 0 0,0 15.29,7.71L18.59,11H7A6,6 0 0,0 1,17A1,1 0 0,0 2,18A1,1 0 0,0 3,17A4,4 0 0,1 7,13H18.59L15.29,16.29A1,1 0 0,0 16.71,17.71L21.71,12.71A1,1 0 0,0 21.71,11.29Z"/>
  </svg>
);
...
export const GameIcon = () => (
  <svg className="w-full h-full" fill="currentColor" viewBox="0 0 24 24">
    <path d="M7.97,16L5,19C4.67,19.3 4.23,19.5 3.75,19.5A1.75,1.75 0 0,1 2,17.75V17.5L3,10.12C3.21,7.81 5.14,6 7.5,6H16.5C18.86,6 20.79,7.81 21,10.12L22,17.5V17.75A1.75,1.75 0 0,1 20.25,19.5C19.77,19.5 19.33,19.3 19,19L16.03,16H7.97M9.5,8A1.5,1.5 0 0,0 8,9.5A1.5,1.5 0 0,0 9.5,11A1.5,1.5 0 0,0 11,9.5A1.5,1.5 0 0,0 9.5,8M16.5,9.5A1.5,1.5 0 0,0 15,8A1.5,1.5 0 0,0 13.5,9.5A1.5,1.5 0 0,0 15,11A1.5,1.5 0 0,0 16.5,9.5Z"/>
  </svg>
);

export const BookIcon = () => (
  <svg className="w-full h-full" fill="currentColor" viewBox="0 0 24 24">
    <path d="M19,2L14,6.5V17.5L19,13V2M6.5,5C4.55,5 2.45,5.4 1,6.5V21.16C1,21.41 1.25,21.66 1.5,21.66C1.6,21.66 1.65,21.59 1.75,21.59C3.1,20.94 5.05,20.68 6.5,20.68C8.45,20.68 10.55,21.1 12,22C13.35,21.15 15.8,20.68 17.5,20.68C19.15,20.68 20.85,21.1 22.25,21.81C22.35,21.86 22.4,21.91 22.5,21.91C22.75,21.91 23,21.66 23,21.41V6.5C22.4,6.05 21.75,5.75 21,5.5V19C19.9,18.65 18.7,18.5 17.5,18.5C15.8,18.5 13.35,18.9 12,19.5V8C10.55,7.15 8.45,6.5 6.5,6.5H6.5Z"/>
  </svg>
);

export const ShoppingIcon = () => (
  <svg className="w-full h-full" fill="currentColor" viewBox="0 0 24 24">
    <path d="M19,7H16V6A4,4 0 0,0 8,6V7H5A1,1 0 0,0 4,8V19A3,3 0 0,0 7,22H17A3,3 0 0,0 20,19V8A1,1 0 0,0 19,7M10,6A2,2 0 0,1 14,6V7H10V6M18,19A1,1 0 0,1 17,20H7A1,1 0 0,1 6,19V9H8V10A1,1 0 0,0 10,10A1,1 0 0,0 10,10V9H14V10A1,1 0 0,0 16,10A1,1 0 0,0 14,10V9H18V19Z"/>
  </svg>
);
...
// Keep existing smaller icons for navigation and other UI elements
...
export const DesignerIcon = () => (
  <svg className="w-3 h-3" fill="currentColor" viewBox="0 0 20 20">
    ...
    <path d="M15 7h1a2 2 0 012 2v5.5a1.5 1.5 0 01-3 0V9a1 1 0 00-1-1h-1v4.5a1.5 1.5 0 01-3 0V7h5z" />
  </svg>
);
